		...
		if (i < (argc - 1)) {
			if (!strcmp(argv[i], "--scoring")) {
				...
				call_analyze(argv[i + 1], 
					...
					"BKKIKSBPNSQMNEELGCLPBELCLBPLNDECMEIOMLBCLOQNDOOYNCIDILDIGQIGONNLPKPIQPKQLPQOLIPQMKIIMKDODQGBKLRCQDLMIBGPCEKMOGPOPMMOBRPEKIDNENCDBPBNNIMPMNEKMPCEOCBLDMMBLMKLKNMTQKRCKIGBDDFDQBGBKNDLLLBPMGE",
					// n=10
