		...
		if (i < (argc - 1)) {
			if (!strcmp(argv[i], "--scoring")) {
				...
				call_analyze(argv[i + 1], 
					...
					"1521145414541443541552534115215544553252453411554133214135424143235253455213555544145551521145351454144552414333314234311152243155341154455521111425224242341453411553214154215411521555553234442343",
